...
def selectionDAWeigths(df,year,PDType,whichAna,fakeRateSel):
    dftag =(df.Define("PDType","\"{0}\"".format(PDType))
              .Define("weightFake1","compute_matrixWeight(isData,fake_Muon_pt,fake_Muon_eta,tight_mu,{0},fake_Electron_pt,fake_Electron_eta,tight_el,{1},{2}, 0, 0)".format(fakeRateSel[0],fakeRateSel[0],whichAna))
              ...
              .Define("weightFakeAltm01","weight/weightFake*compute_matrixWeight(isData,fake_Muon_pt,fake_Muon_eta,tight_mu,{0},fake_Electron_pt,fake_Electron_eta,tight_el,{1},{2}, 1, 0)".format(fakeRateSel[1],fakeRateSel[0],whichAna))
              .Define("weightFakeAltm0", "Total_TT - weightFakeAltm01")
              .Define("weightFakeAltm11","weight/weightFake*compute_matrixWeight(isData,fake_Muon_pt,fake_Muon_eta,tight_mu,{0},fake_Electron_pt,fake_Electron_eta,tight_el,{1},{2}, 2, 0)".format(fakeRateSel[2],fakeRateSel[0],whichAna))
              .Define("weightFakeAltm1", "Total_TT - weightFakeAltm11")
              .Define("weightFakeAltm21","weight/weightFake*compute_matrixWeight(isData,fake_Muon_pt,fake_Muon_eta,tight_mu,{0},fake_Electron_pt,fake_Electron_eta,tight_el,{1},{2}, 3, 0)".format(fakeRateSel[3],fakeRateSel[0],whichAna))
              .Define("weightFakeAltm2", "Total_TT - weightFakeAltm21")         
              .Define("weightFakeAlte01","weight/weightFake*compute_matrixWeight(isData,fake_Muon_pt,fake_Muon_eta,tight_mu,{0},fake_Electron_pt,fake_Electron_eta,tight_el,{1},{2}, 0, 1)".format(fakeRateSel[0],fakeRateSel[1],whichAna))
              .Define("weightFakeAlte0", "Total_TT - weightFakeAlte01")
              .Define("weightFakeAlte11","weight/weightFake*compute_matrixWeight(isData,fake_Muon_pt,fake_Muon_eta,tight_mu,{0},fake_Electron_pt,fake_Electron_eta,tight_el,{1},{2}, 0, 2)".format(fakeRateSel[0],fakeRateSel[2],whichAna))
              .Define("weightFakeAlte1", "Total_TT - weightFakeAlte11")
              .Define("weightFakeAlte21","weight/weightFake*compute_matrixWeight(isData,fake_Muon_pt,fake_Muon_eta,tight_mu,{0},fake_Electron_pt,fake_Electron_eta,tight_el,{1},{2}, 0, 3)".format(fakeRateSel[0],fakeRateSel[3],whichAna))
