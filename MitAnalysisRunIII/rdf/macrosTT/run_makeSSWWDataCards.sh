#!/bin/sh
# to run: ./run_makeSSWWDataCards.sh 1001 0
if [ $# -lt 2 ]; then
...
if [ $theOption -eq 0 ]; then
  ...
  root -l -q -b makeSSWWDataCards.C'(0,'${bin}',"/mnt/home/mghimiray/VBSStudies/Outputs_VBS/OriginalTT/1001/merge1/","'${theAna}'",'${year}')';
