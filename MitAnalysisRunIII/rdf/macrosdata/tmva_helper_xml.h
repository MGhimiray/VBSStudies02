class tmva_xml {
    ...
    //        fExpressions = c.variables;   // Trying new expression.
			fExpressions = c.variable_expressions;   //Monika change to c.variable_expressions for newer ROOT
...
//        using Vec_f = std::vector<float>;  //monika added line
