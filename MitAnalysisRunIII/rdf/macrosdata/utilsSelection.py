...
def selectionDAWeigths(df,year,PDType,whichAna,fakeRateSel):
    dftag =(df.Define("PDType","\"{0}\"".format(PDType))
              ...
              .Define("weightFakeAltm0","1")
              .Define("weightFakeAltm1","1")
              .Define("weightFakeAltm2","1")
              .Define("weightFakeAlte0","1")
              .Define("weightFakeAlte1","1")
              .Define("weightFakeAlte2","1")
