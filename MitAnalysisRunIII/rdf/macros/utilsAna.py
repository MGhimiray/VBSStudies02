...
##### 2023 ####
        ...
        filesL = findDIR("{0}/2023C/Muoneg".format(dirT2))
#            filesL.push_back(x)
    elif(year == 2023 and type == 1023):
        filesL = findDIR("{0}/2023D/Muoneg".format(dirT2))
#            filesL.push_back(x)
    

    elif(year == 2023 and type == 1032):
        filesL   = findDIR("{0}/2023C/Egamma0".format(dirT2))
        filesAux = findDIR("{0}/2023C/Egamma1".format(dirT2))
        for x in filesAux:
            filesL.push_back(x)

    elif(year == 2023 and type == 1033):
        filesL   = findDIR("{0}/2023D/Egamma0".format(dirT2))
        filesAux = findDIR("{0}/2023D/Egamma1".format(dirT2))
        for x in filesAux:
            filesL.push_back(x)

    elif(year == 2023 and type == 1042):
        filesL   = findDIR("{0}/2023C/Muon0".format(dirT2))
        filesAux = findDIR("{0}/2023C/Muon1".format(dirT2))
        for x in filesAux:
            filesL.push_back(x)
        
    elif(year == 2023 and type == 1043):
        filesL   = findDIR("{0}/2023D/Muon0".format(dirT2))
        filesAux = findDIR("{0}/2023D/Muon1".format(dirT2))
        for x in filesAux:
            filesL.push_back(x)
...
def SwitchSample(argument, skimType):
    ...
    dirT2 = "/mnt/home/mghimiray/VBSStudies/DATAMC/"
...
# Era C 2023, 20230
       ...
       311: (dirT2+"/2023/tbarW/2023C/",4.67*1000,plotCategory("kPlotTW")),
       312: (dirT2+"/2023/tWminus/2023C/",4.67*1000,plotCategory("kPlotTW")),
       ...
       314: (dirT2+"/2023/WWW/2023C/",0.23280*1000,plotCategory("kPlotVVV")),
       315: (dirT2+"/2023/WWZ/2023C/",0.18510*1000,plotCategory("kPlotVVV")),
       316: (dirT2+"/2023/WZZ/2023C/",0.06206*1000,plotCategory("kPlotVVV")),
       317: (dirT2+"/2023/ZZZ/2023C/",0.01591*1000,plotCategory("kPlotVVV")),
       ...
       319: (dirT2+"/2023/ttWW/2023C/",0.0081651*1000,plotCategory("kPlotTVX")),
       320: (dirT2+"/2023/ttZZ/2023C/",0.0015617*1000,plotCategory("kPlotTVX")),
       ...
       333: (dirT2+"/2023/WGamma10to100/2023C/",668.91538*1000,plotCategory("kPlotVG")),
       334: (dirT2+"/2023/WGamma100to200/2023C/",2.22141*1000,plotCategory("kPlotVG")),
       335: (dirT2+"/2023/WGamma200to400/2023C/",0.291367*1000,plotCategory("kPlotVG")),
       ...
       356: (dirT2+"/2023/WGamma400to600/2023C/",0.022322*1000,plotCategory("kPlotVG")),
       357: (dirT2+"/2023/WGamma600/2023C/",0.004918*1000,plotCategory("kPlotVG")),
       ...
       374: (dirT2+"/2023/wrongsignew/2023C/", 0.3301419*1000,plotCategory("kPlotqqWW")),
       375: (dirT2+"/2023/wrongsignQCD/2023C/",2.6758028*1000,plotCategory("kPlotqqWW")),
       376: (dirT2+"/2023/ssWWew/2023C/",         0.0295255*1000,plotCategory("kPlotEWKSSWW")),
       377: (dirT2+"/2023/ssWWQCD/2023C/",        0.0279662*1000,plotCategory("kPlotQCDSSWW")),
       378: (dirT2+"/2023/WZew/2023C/",           0.0429366*1000,plotCategory("kPlotEWKWZ")),
       379: (dirT2+"/2023/WZQCD/2023C/",          0.4958618*1000*0.70,plotCategory("kPlotWZ")),
       ...
       382: (dirT2+"/2023/ZZ4lew/2023C/",                     0.0011422*1000,plotCategory("kPlotZZ")),
       383: (dirT2+"/2023/ZZ4lQCD/2023C/",                    0.0202984*1000*1.40,plotCategory("kPlotZZ")),
# Era D 2023
       ...
       411: (dirT2+"/2023/tbarW/2023D/",4.67*1000,plotCategory("kPlotTW")),
       412: (dirT2+"/2023/tWminus/2023D/",4.67*1000,plotCategory("kPlotTW")),
       ...
       414: (dirT2+"/2023/WWW/2023D/",0.23280*1000,plotCategory("kPlotVVV")),
       415: (dirT2+"/2023/WWZ/2023D/",0.18510*1000,plotCategory("kPlotVVV")),
       416: (dirT2+"/2023/WZZ/2023D/",0.06206*1000,plotCategory("kPlotVVV")),
       417: (dirT2+"/2023/ZZZ/2023D/",0.01591*1000,plotCategory("kPlotVVV")),
       ...
       419: (dirT2+"/2023/ttWW/2023D/",0.0081651*1000,plotCategory("kPlotTVX")),
       420: (dirT2+"/2023/ttZZ/2023D/",0.0015617*1000,plotCategory("kPlotTVX")),
       ...
       433: (dirT2+"/2023/WGamma10to100/2023D/",668.91538*1000,plotCategory("kPlotVG")),
       434: (dirT2+"/2023/WGamma100to200/2023D/",2.22141*1000,plotCategory("kPlotVG")),
       435: (dirT2+"/2023/WGamma200to400/2023D/",0.291367*1000,plotCategory("kPlotVG")),
       ...
       456: (dirT2+"/2023/WGamma400to600/2023D/",0.022322*1000,plotCategory("kPlotVG")),
       457: (dirT2+"/2023/WGamma600/2023D/",0.004918*1000,plotCategory("kPlotVG")),
       ...
       474: (dirT2+"/2023/wrongsignew/2023D/", 0.3301419*1000,plotCategory("kPlotqqWW")),
       475: (dirT2+"/2023/wrongsignQCD/2023D/",2.6758028*1000,plotCategory("kPlotqqWW")),
       476: (dirT2+"/2023/ssWWew/2023D/",         0.0295255*1000,plotCategory("kPlotEWKSSWW")),
       477: (dirT2+"/2023/ssWWQCD/2023D/",        0.0279662*1000,plotCategory("kPlotQCDSSWW")),
       478: (dirT2+"/2023/WZew/2023D/",           0.0429366*1000,plotCategory("kPlotEWKWZ")),
       479: (dirT2+"/2023/WZQCD/2023D/",          0.4958618*1000*0.70,plotCategory("kPlotWZ")),
       ...
       482: (dirT2+"/2023/ZZ4lew/2023D/",                     0.0011422*1000,plotCategory("kPlotZZ")),
       483: (dirT2+"/2023/ZZto4lQCD/2023D/",                    0.0202984*1000*1.40,plotCategory("kPlotZZ")),
